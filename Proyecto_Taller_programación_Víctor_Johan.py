...
def transformarDict(x):
    """this function have the duty of convert a string representation of a dictionary,list,tuple etc. """
    z = eval(x)
    return z
def emotions(picture):
    """The emotions function have the utility of analize a person's face and obtain data of the features of the face"""
...
def recognize_person(foto,id_grupo):
    """The recognize person function have the utility of recognize a person's image and identify the position of the face"""
    print(foto, " ", id_grupo)
...
def creargrupo(id_grupo,group_name):
    """an a standard cognitive face function for create a group of people where you can save the information of the people you create"""
...
def crearpersona(nombre,profesion,foto,id_grupo):
    """This Function obtain the data of a person by the use of the function emotions and add the information to a person, next it save the created person in a group"""
...
documentacion1 = creargrupo.__doc__
documentacion2 =crearpersona.__doc__
documentacion3 =recognize_person.__doc__
documentacion4 =emotions.__doc__
documentacion5 =transformarDict.__doc__
print("creargrupo: ",documentacion1,"\n\n crearpersona: ",documentacion2,"\n\n recognize_person: ",documentacion3,"\n\n emotions: ",documentacion4,"\n\n tranformarDict: ",documentacion5)